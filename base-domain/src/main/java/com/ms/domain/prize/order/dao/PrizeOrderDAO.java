package com.ms.domain.prize.order.dao;

import java.io.Serializable;
import java.math.BigDecimal;
import java.util.Date;

public class PrizeOrderDAO implements Serializable{

	private static final long serialVersionUID = 4980999764884976443L;
